...
(() => {
  ...
  var LIGHT_MEMORY_STORAGE_KEY = "nodalia-light-card:last-visual-state:v1";
  var COLOR_PRESETS = [
  ...
  function normalizeConfig(rawConfig) {
    ...
    const iconHoldStr = iconHoldRaw === void 0 || iconHoldRaw === null ? "" : String(iconHoldRaw).trim();
    if (!iconHoldStr) {
    ...
    _render() {
          ...
          <div class="light-card__slider-row">
            ...
            ${useSliderModeButtons ? `
                  <div class="light-card__mode-actions">
                      ${availableControlModes.filter((mode) => mode !== displayedControlMode).map((mode) => `
                          <button
                            type="button"
                            class="light-card__mode-button"
      ...
      <style>
        ...
        * {
        ...
        .light-card::before {
          background: ${isOn ? `linear-gradient(180deg, color-mix(in srgb, ${accentColor} 22%, color-mix(in srgb, var(--primary-text-color) 6%, transparent)), rgba(255, 255, 255, 0))` : "linear-gradient(180deg, color-mix(in srgb, var(--primary-text-color) 5%, transparent), rgba(255, 255, 255, 0))"};
          content: "";
          inset: 0;
          pointer-events: none;
          position: absolute;
        ...
        .light-card__icon {
          background: ${isOn ? `color-mix(in srgb, ${accentColor} 24%, color-mix(in srgb, var(--primary-text-color) 8%, transparent))` : "color-mix(in srgb, var(--primary-text-color) 6%, transparent)"};
      ...
      >
        <div class="light-card__content ${shouldAnimateEntrance ? "light-card__content--entering" : ""}">
          <div class="light-card__hero">
            ...
            >
              ${entityPicture ? `<img class="light-card__picture" src="${escapeHtml(entityPicture)}" alt="" loading="lazy" />` : `<ha-icon icon="${escapeHtml(icon)}"></ha-icon>`}
