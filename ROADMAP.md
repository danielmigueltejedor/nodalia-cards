...
Preview **`2.3.0-alpha.2`** stops Room Summary Hub flicker and shows configured camera, media, power and security entities. Stable **`2.2.9`** remains the recommended daily-driver release.
