...
/** Key = English seed (`row.en`). Values must include fr; de/it/nl optional (fallback to shim row). */
const PATCHES = {
  Haptics: {
    fr: "Haptique",
    de: "Haptik",
...
/** French-only patches for “Show …” and similar compound labels (de/it/nl keep generator shims). */
const SHOW_AND_LABEL_FR = {
  "Show Meteoalarm chip": "Afficher la puce Meteoalarm",
  "Show PIN text field": "Afficher le champ PIN",
  "Show animation settings": "Afficher les paramètres d’animation",
  "Show away": "Afficher Absent",
  "Show bottom icon": "Afficher l’icône inférieure",
  "Show brightness": "Afficher la luminosité",
  "Show chart labels": "Afficher les étiquettes du graphique",
  "Show condition": "Afficher la condition",
  "Show current state": "Afficher l’état actuel",
  "Show current temperature chip": "Afficher la température actuelle",
  "Show custom": "Afficher Personnalisé",
  "Show disarm": "Afficher Désarmer",
  "Show energy button": "Afficher le bouton énergie",
  "Show extended forecast": "Afficher les prévisions étendues",
  "Show fan chip": "Afficher la puce ventilateur",
  "Show fan mode button": "Afficher le bouton mode ventilateur",
  "Show fill": "Afficher le remplissage",
  "Show header": "Afficher l’en-tête",
  "Show home": "Afficher Domicile",
  "Show humidity chip": "Afficher la puce humidité",
  "Show icon": "Afficher l’icône",
  "Show labels": "Afficher les étiquettes",
  "Show large value": "Afficher la grande valeur",
  "Show legend": "Afficher la légende",
  "Show location": "Afficher la position",
  "Show min/max range": "Afficher la plage min/max",
  "Show mode button": "Afficher le bouton de mode",
  "Show mode buttons": "Afficher les boutons de mode",
  "Show mode chip": "Afficher la puce de mode",
  "Show mode presets": "Afficher les préréglages de mode",
  "Show name": "Afficher le nom",
  "Show name in chip": "Afficher le nom dans la puce",
  "Show night": "Afficher Nuit",
  "Show on desktop": "Afficher sur bureau",
  "Show or hide each card block.": "Afficher ou masquer chaque bloc de la carte.",
  "Show oscillate button": "Afficher le bouton oscillation",
  "Show percentage chip": "Afficher la puce pourcentage",
  "Show pressure chip": "Afficher la puce pression",
  "Show primary chip": "Afficher la puce principale",
  "Show room labels": "Afficher les noms des pièces",
  "Show room markers": "Afficher les marqueurs de pièces",
  "Show secondary chip": "Afficher la puce secondaire",
  "Show slider": "Afficher le curseur",
  "Show sources and apps": "Afficher les sources et les applications",
  "Show speed chip": "Afficher la puce vitesse",
  "Show state": "Afficher l’état",
  "Show state bubble": "Afficher la bulle d’état",
  "Show state chip": "Afficher la puce d’état",
  "Show state in bubble": "Afficher l’état dans la bulle",
  "Show style settings": "Afficher les paramètres de style",
  "Show target humidity chip": "Afficher la puce humidité cible",
  "Show textual state": "Afficher l’état textuel",
  "Show unavailable badge": "Afficher le badge indisponible",
  "Show vacation": "Afficher Vacances",
  "Show value": "Afficher la valeur",
  "Show view selector": "Afficher le sélecteur de vue",
  "Show wind chip": "Afficher la puce vent",
  "Show zone badge": "Afficher le badge de zone",
};

for (const [en, fr] of Object.entries(SHOW_AND_LABEL_FR)) {
  PATCHES[en] = { ...(PATCHES[en] || {}), fr };
}
