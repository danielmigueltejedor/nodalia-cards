...
# set package.json to e.g. 1.0.0-alpha.77, changelog section, npm run bundle
...
3. **`alpha` / `beta` (experimental)** — after shipping **`0.6.1` stable, continue the next major line as `1.0.0-alpha.*` for experimental work and promote polished batches to **`1.0.0-beta.*`**. Current alpha: **`1.0.0-alpha.77`**; current beta candidate: **`1.0.0-beta.7`**.
