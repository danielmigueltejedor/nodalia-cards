...
# set package.json to e.g. 1.0.0-alpha.48, changelog section, npm run bundle
...
3. **`alpha` (experimental)** — after shipping **`0.6.1` stable, continue the next major line as `1.0.0-alpha.*` (currently **`1.0.0-alpha.48`**) and promote to **`1.0.0-beta.*`** when ready.
