/* Generated from src/cards/humidifier. Do not edit. */
"use strict";
(() => {
    ...
    `;
      ...
      <style>
        ...
        * {
        ...
        ha-card::before {
          background: ${isOn ? `linear-gradient(180deg, color-mix(in srgb, ${accentColor} 18%, color-mix(in srgb, var(--primary-text-color) 6%, transparent)), rgba(255, 255, 255, 0))` : "linear-gradient(180deg, color-mix(in srgb, var(--primary-text-color) 5%, transparent), rgba(255, 255, 255, 0))"};
          content: "";
          inset: 0;
          pointer-events: none;
          position: absolute;
        ...
        .humidifier-card__icon ha-icon {
          ...
          color: ${darkenBubbleIconGlyph ? `color-mix(in srgb, var(--primary-text-color) 56%, ${accentColor})` : isOn ? styles.icon.on_color : styles.icon.off_color};
          display: inline-flex;
      ...
      >
        <div class="humidifier-card__content ${shouldAnimateEntrance ? "humidifier-card__content--entering" : ""}">
          <div class="humidifier-card__hero">
            ...
            >
              ${entityPicture ? `<img class="humidifier-card__picture" src="${escapeHtml(entityPicture)}" alt="" loading="lazy" />` : `<ha-icon icon="${escapeHtml(icon)}"></ha-icon>`}
