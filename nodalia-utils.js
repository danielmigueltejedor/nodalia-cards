...
(function initNodaliaUtils() {
  ...
  function applyCardTapActionField(config, keys, rawValue, fallback) {
    ...
    const actionData = rawValue.service_data !== undefined && rawValue.service_data !== null
    ...
    if (serviceTargetKey && isObject(rawValue.target) && Object.keys(rawValue.target).length && !String(config[serviceTargetKey] || "").trim()) {
