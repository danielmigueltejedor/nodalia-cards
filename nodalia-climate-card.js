...
${weekdayYaml}
  ...
  var _lazyNodaliaClimateCardEditorLegacy;
  function loadNodaliaClimateCardEditorLegacy() {
  ...
  var _lazyNodaliaClimateCardEditor;
  function loadNodaliaClimateCardEditor() {
  ...
  var _legacyEditorKept = customElements.get(`${EDITOR_TAG}-legacy`) === loadNodaliaClimateCardEditorLegacy();
})();
