...
## [0.3.0-beta.3] - 2026-05-03

### Changed

- **Prerelease track**: merge **`main` v0.2.1**; bump to **0.3.0-beta.3**; **`nodalia-cards.js`** rebundled with `__NODALIA_BUNDLE__.pkgVersion` set for the beta line.
