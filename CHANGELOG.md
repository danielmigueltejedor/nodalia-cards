...
## [1.0.0-alpha.45] - 2026-05-07

Forty-fifth **`alpha`** on **`1.0.0`**. Installs match **`package.json`** / **`__NODALIA_BUNDLE__.pkgVersion`** **`1.0.0-alpha.45`** (tag **`v1.0.0-alpha.45`** optional).
...
- **Release metadata:** bump alpha channel references and bundle version metadata to **`1.0.0-alpha.45`**.
