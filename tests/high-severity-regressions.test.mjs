...
test("vacuum auto-discovery picks up helper entities that appear after the first hass snapshot", () => {
  ...
  card.hass = {
    states: {
      ...
      "sensor.roborock_s7_room_mapping": { entity_id: "sensor.roborock_s7_room_mapping", state: "kitchen" },
