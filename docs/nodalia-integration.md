...
## Compatibility for Nodalia Cards 2.2.3-alpha.2

| Component | Supported baseline | Recommended for 2.2.3-alpha.2 |
|---|---|---|
| Home Assistant | `2025.1.0` or newer | Current supported stable release |
| Nodalia Cards | `2.0.2` or newer for Engine discovery | `2.2.3-alpha.2` |
| Nodalia Cards Engine | WebSocket API `2` | Stable `2.0.2` |

Cards `2.2.3-alpha.2` and Engine `2.0.2` use the same API generation. The Engine remains optional: ordinary controls, layouts and visual editors do not require it.
