...
The card ships in the main Nodalia Cards HACS bundle. Add the versioned resource (for example `nodalia-cards-1.3.1-alpha.3.js`) to Lovelace resources, then use the YAML below.
