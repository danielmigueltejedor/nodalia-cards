...
(() => {
  ...
  var _lazyNodaliaGraphCardEditorLegacy;
  function loadNodaliaGraphCardEditorLegacy() {
  ...
  var _legacyEditorKept = customElements.get(`${EDITOR_TAG}-legacy`) === loadNodaliaGraphCardEditorLegacy();
})();
