...
For **stable** releases see **`[1.0.0]`** and **`[1.0.1]`**; for **`1.0.2`** prereleases (for example **`[1.0.2-alpha.11]`**) see [`CHANGELOG.md`](./CHANGELOG.md). This file only archives the historical **`1.0.0-alpha.*`** / **`1.0.0-beta.*`** line.
