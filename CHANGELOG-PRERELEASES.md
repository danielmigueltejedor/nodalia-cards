...
For **stable** releases see **`[1.0.0]`**, **`[1.0.1]`**, and **`[1.0.2]`**; for **`1.0.3`** prereleases (for example **`[1.0.3-alpha.5]`**, **`[1.0.3-alpha.4]`**, **`[1.0.3-alpha.3]`**, **`[1.0.3-alpha.2]`**, or **`[1.0.3-alpha.1]`**) and **`1.0.2`** prereleases (for example **`[1.0.2-alpha.12]`**) see [`CHANGELOG.md`](./CHANGELOG.md). This file only archives the historical **`1.0.0-alpha.*`** / **`1.0.0-beta.*`** line.
