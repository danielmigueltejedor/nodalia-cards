...
![Beta prerelease](https://img.shields.io/badge/beta-1.0.0--beta.1-blue)
...
**Prereleases:** current **`1.0.0`** prerelease is **`1.0.0-beta.1`** (**`beta`** channel). **`0.6.1`** stays as the recommended stable line on **`main`** while polish continues toward **`1.0.0`** stable.
