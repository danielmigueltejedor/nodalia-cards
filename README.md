...
![Package](https://img.shields.io/badge/package-1.0.2--alpha.9-df7138)
...
**This branch installs `1.0.2-alpha.9`** — match **`package.json`** and **`window.__NODALIA_BUNDLE__.pkgVersion`**. Latest **stable** on **`main`** is **`1.0.1`**. The sections below summarize the **`1.0.0`** milestone; release notes for **`1.0.2-alpha.9`**, **`1.0.2-alpha.8`**, **`1.0.2-alpha.7`**, **`1.0.2-alpha.6`**, **`1.0.2-alpha.5`**, **`1.0.2-alpha.4`**, **`1.0.2-alpha.3`**, **`1.0.2-alpha.2`**, **`1.0.2-alpha.1`**, **`1.0.1`**, and earlier are in [`CHANGELOG.md`](./CHANGELOG.md).
