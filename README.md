...
**Prereleases:** active **`1.0.0-alpha.*`** line is now **`1.0.0-alpha.68`** on **`alpha`**. **`1.0.0-beta.1`** remains documented in **CHANGELOG** as the current beta candidate. **`0.6.1`** stays as the recommended stable line on **`main`** while final polish continues toward **`1.0.0`** stable.
