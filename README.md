...
**Prerelease `1.2.0-alpha.2`** (alpha branch) — match **`package.json`**, **`hacs.json`**, **`nodalia-cards.manifest.js`**, **`nodalia-cards-1.2.0-alpha.2.js`**, and **`window.__NODALIA_BUNDLE__.pkgVersion`**. Stable **`1.1.3`** is on **`main`**. Release notes: [`CHANGELOG.md`](./CHANGELOG.md) and [`CHANGELOG-PRERELEASES.md`](./CHANGELOG-PRERELEASES.md).
...
```text
/hacsfiles/nodalia-cards/nodalia-cards-1.2.0-alpha.2.js
```
