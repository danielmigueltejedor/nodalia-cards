...
Nodalia Cards Engine is a separate HACS **Integration** that runs advanced features inside Home Assistant even when no dashboard is open. Stable Engine `2.0.2` is the recommended companion for Nodalia Cards `2.2.0-alpha.8`.
