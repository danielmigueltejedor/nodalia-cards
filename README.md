...
![Alpha branch](https://img.shields.io/badge/alpha-0.5.0--alpha.4-orange)
...
**Prereleases:** **`alpha`** **`0.5.0-alpha.4`** (experimental; **may break** dashboards) leads **`0.5.x`** development ahead of **`main`**. Stable **`0.4.0`** remains **`package.json`** on **`main`** until the next stable merge. Branch workflow and tagging: **CONTRIBUTING**.
