...
![Package](https://img.shields.io/badge/package-1.1.1--alpha.3-fbca04)
![Prerelease channel](https://img.shields.io/badge/prerelease%20channel-1.1.1--alpha.3-fbca04)
...
**This branch tracks prerelease `1.1.1-alpha.3`** — match **`package.json`**, **`hacs.json`**, **`nodalia-cards.manifest.js`**, **`nodalia-cards-1.1.1-alpha.3.js`**, and **`window.__NODALIA_BUNDLE__.pkgVersion`**. The sections below summarize the **`1.0.0`** milestone and newer cards; release notes are in [`CHANGELOG.md`](./CHANGELOG.md).
...
```text
/hacsfiles/nodalia-cards/nodalia-cards-1.1.1-alpha.3.js
```
