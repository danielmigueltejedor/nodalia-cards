...
**Prereleases:** **`alpha`** **`0.6.0-alpha.2`** (experimental; **may break** dashboards) starts the next development line. Current stable on **`main`** is **`0.5.0`**. Branch workflow and tagging: **CONTRIBUTING**.
