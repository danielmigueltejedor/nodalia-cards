...
**Prereleases:** active **`1.0.0-beta.*`** line is now **`1.0.0-beta.2`** on **`beta`**. **`1.0.0-alpha.68`** remains the latest alpha validation build. **`0.6.1`** stays as the recommended stable line on **`main`** while final polish continues toward **`1.0.0`** stable.
