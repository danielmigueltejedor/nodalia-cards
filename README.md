...
**Prereleases:** active **`1.0.0-alpha.*`** line is now **`1.0.0-alpha.89`** on **`alpha`**. **`1.0.0-beta.7`** remains the latest beta validation build. **`0.6.1`** stays as the recommended stable line on **`main`** while final polish continues toward **`1.0.0`** stable.
